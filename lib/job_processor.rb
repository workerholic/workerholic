  ...
  class JobProcessor
    ...
    def process
      ...
      begin
        ...
        @log_manager.log('info', "Completed: your job from class #{job.klass} was completed on #{job.statistics.completed_at}.")
        ...
        @log_manager.log('error', "Failed: your job from class #{job.class} was unsuccessful. Retrying in 10 seconds.")
      end
